    ...
    public partial class AcademyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CourseStudent>(entity =>
            {
                ...
                entity.HasIndex(e => e.StudentId, "un_course_student")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Student)
                    .WithOne(p => p.CourseStudent)
                    .HasForeignKey<CourseStudent>(d => d.StudentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<Location>(entity =>
            {
                ...
                entity.Property(e => e.LasUpdate).HasColumnName("las_update");
